// Generated by gencpp from file kraken_msgs/forceData4Thruster.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::kraken_msgs::forceData4Thruster_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::kraken_msgs::forceData4Thruster_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kraken_msgs::forceData4Thruster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::kraken_msgs::forceData4Thruster_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kraken_msgs::forceData4Thruster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::kraken_msgs::forceData4Thruster_<ContainerAllocator> const>
  : TrueType
  { };
