...
"""autogenerated by genpy from ip_msgs/buoyActionFeedback.msg. Do not edit."""
import sys
...
class buoyActionFeedback(genpy.Message):
  _md5sum = "7372d24bdf6bb3f4558f71aeaf96c1d2"
  _type = "ip_msgs/buoyActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ip_msgs/buoyFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(buoyActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ip_msgs.msg.buoyFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ip_msgs.msg.buoyFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.errorx, _x.feedback.errory,) = _struct_2i.unpack(str[start:end])
      return self
