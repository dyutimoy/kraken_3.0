...
class scanActionGoal {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = scanGoal.serialize(obj.goal, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    tmp = scanGoal.deserialize(buffer);
    data.goal = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
