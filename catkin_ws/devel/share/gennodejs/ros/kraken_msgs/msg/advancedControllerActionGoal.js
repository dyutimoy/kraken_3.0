...
class advancedControllerActionGoal {
  constructor() {
    this.header = new std_msgs.msg.Header();
    this.goal_id = new actionlib_msgs.msg.GoalID();
    this.goal = new advancedControllerGoal();
  }
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = advancedControllerGoal.serialize(obj.goal, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new advancedControllerActionGoal();
    ...
    tmp = advancedControllerGoal.deserialize(buffer);
    data.goal = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
...
module.exports = advancedControllerActionGoal;
