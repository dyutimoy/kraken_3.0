...
class setYawActionGoal {
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = setYawGoal.serialize(obj.goal, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    tmp = setYawGoal.deserialize(buffer);
    data.goal = tmp.data;
    buffer = tmp.buffer;
    return {
      data: data,
...
module.exports = setYawActionGoal;
