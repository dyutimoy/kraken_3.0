...
class scanActionFeedback {
  constructor() {
    this.header = new std_msgs.msg.Header();
    this.status = new actionlib_msgs.msg.GoalStatus();
    this.feedback = new scanFeedback();
  }
  ...
  static serialize(obj, bufferInfo) {
    ...
    bufferInfo = scanFeedback.serialize(obj.feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new scanActionFeedback();
    ...
    tmp = scanFeedback.deserialize(buffer);
...
module.exports = scanActionFeedback;
