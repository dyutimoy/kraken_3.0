...
class setYawAction {
  constructor() {
    this.action_goal = new setYawActionGoal();
    this.action_result = new setYawActionResult();
    this.action_feedback = new setYawActionFeedback();
  }

  static serialize(obj, bufferInfo) {
    // Serializes a message object of type setYawAction
    // Serialize message field [action_goal]
    bufferInfo = setYawActionGoal.serialize(obj.action_goal, bufferInfo);
    // Serialize message field [action_result]
    bufferInfo = setYawActionResult.serialize(obj.action_result, bufferInfo);
    // Serialize message field [action_feedback]
    bufferInfo = setYawActionFeedback.serialize(obj.action_feedback, bufferInfo);
    return bufferInfo;
  }
  ...
  static deserialize(buffer) {
    ...
    let tmp;
    let len;
    let data = new setYawAction();
    // Deserialize message field [action_goal]
    tmp = setYawActionGoal.deserialize(buffer);
    data.action_goal = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_result]
    tmp = setYawActionResult.deserialize(buffer);
    data.action_result = tmp.data;
    buffer = tmp.buffer;
    // Deserialize message field [action_feedback]
    tmp = setYawActionFeedback.deserialize(buffer);
